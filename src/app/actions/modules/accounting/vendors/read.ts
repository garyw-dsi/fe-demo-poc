...
type Vendor = components['schemas']['Contact'];

export const getAllVendorAccounting = async({
  page = 1, 
  page_size = 10
}: {
  page?: number;
  ...
  try {
    ...
    return {
      status: "success",
      message: "Successfully get all vendor accounting",
      data: {
        items: data,
        page: page,
        page_size: page_size,
    ...
    const message = error instanceof Error
      ? error.message
      : "Failed to get all vendor accounting";
...
export const getVendorAccounting = async ({ pk }: { pk: number }) => { 
  try {
    ...
    return {
      status: "success",
      message: "Successfully get vendor accounting",
      data: {
        vendor: {
          vendor: vendorMin,
          contact: contact,
    ...
    const message = error instanceof Error
      ? error.message
      : "Failed to get vendor accounting";
