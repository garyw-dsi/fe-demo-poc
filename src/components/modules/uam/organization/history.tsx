...
export default function ModuleUAMOrganizationHistory({
  history
}: {
  history: components['schemas']['Organization']
}) {
  return (
    <Flex direction={'column'} gap={5}>
      ...
      >
        <ModuleHistory
          ...
          historyName={history.legal_name}
          historyTitle="Created organization "
        ...
        {history.last_modified_by && (
          <ModuleHistory
            ...
            historyName={history.legal_name}
            historyTitle="Updated organization "
