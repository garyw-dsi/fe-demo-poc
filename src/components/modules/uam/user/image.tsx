...
interface ModuleUAMUserSetImageProps {
...
export default function ModuleUAMUserSetImage({
  setFile
}: ModuleUAMUserSetImageProps) {
  const toast = useToast();
  const imageRef = useRef<HTMLInputElement>(null);
  const { setFieldValue, values, setTouched } = useFormikContext<CreateUser>();
