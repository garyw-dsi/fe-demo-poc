...
export default function ModuleUAMGroupDetailHistory({
  history
}: {
  history: components['schemas']['Group']
}) {
  return (
    <Flex direction={'column'} gap={5}>
      ...
      >
        <ModuleHistory
          ...
          name={`${history.created_by.first_name} ${history.created_by.last_name}`}
          historyName={history.name}
          historyTitle="Created group "
