...
import ModuleAccountingCustomerFormLayout from "@/components/modules/accounting/customers/layout";
...
export default function ModuleAccountingCustomerJournalDetail({
  datas,
}: {
  datas: JournalDetails[];
}) {
  return (
    <ModuleAccountingCustomerFormLayout title="Accounting Journal Detail">
      <ITable>
