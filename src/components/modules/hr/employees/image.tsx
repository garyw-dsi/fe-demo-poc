...
interface ModuleHREmployeeSetImageProps {
...
export default function ModuleHREmployeeSetImage({
  setFile
}: ModuleHREmployeeSetImageProps) {
  const toast = useToast();
  const imageRef = useRef<HTMLInputElement>(null);
  const { setFieldValue, values, setTouched } = useFormikContext<CreateEmployee>();
