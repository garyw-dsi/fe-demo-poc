...
export default function ModuleInventoryProductCategoryDetailHistory({
  history
}: {
  history: components['schemas']['ProductCategory']
}) {
  return (
