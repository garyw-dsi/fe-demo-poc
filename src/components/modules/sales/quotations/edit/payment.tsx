...
import { CreateQuotation, paymentN } from "@/libs/yup/sales/quotations";
...
export default function ModuleSalesQuotationPaymentEdit({
  initialData,
  currency
}: {
  ...
  const { errors, touched, values, setFieldValue } = useFormikContext<CreateQuotation>();

  const [paymentDpType, setPaymentDpType] = useState<PaymentDpType>(
    values.payment_dp_rate ? "percentage" : "nomine"
  );
        ...
        >
          ...
          >
            ...
            <ModuleCurrencySelect
              ...
              defaultValues={{
                value: initialData.currency.toString(),
