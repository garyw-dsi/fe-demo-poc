...
import { deleteQuotation } from "@/app/actions/modules/sales/quotations";
...
export default function ModuleSalesQuotationDelete({
  isOpen,
  onClose,
  pk
}: Props) {
  ...
  const onDelete = async () => {
    try {
      ...
      if (response.status === "success") {
        router.replace("/modules/sales/quotations");
