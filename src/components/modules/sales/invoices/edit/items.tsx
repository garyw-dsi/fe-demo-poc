...
export default function ModuleSalesInvoiceItemsEdit({
  initialData, vats
}: {
                ...
                <ITableBody>
                  {values.items.map((item, index) => (
                    <Tr key={index}>
                      <Td>
                        <Text fontSize="sm">
                          {initialData.items.find((i) => i.order_item.pk === item.order_item_id)?.order_item.product.name}
                        </Text>
                      </Td>
                      <Td w={"32"}>
                        {initialData.items.find((i) => i.order_item.pk === item.order_item_id)?.order_item.product.unit}
                      </Td>
                      ...
                      <Td>
                        <ModuleVATSelect
                          ...
                          defaultValue={
                            initialData?.items[index]?.order_item.vat
                              ? {
                                value: initialData.items[index].order_item.vat.pk.toString(),
                                label: Number(initialData.items[index].order_item.vat.rate) * 100 + "%",
                              }
                              : undefined
                          }
                        />
