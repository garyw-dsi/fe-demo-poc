...
export default function ModulePurchaseOrderItemsCreate({
  initialData
}: {
  ...
  const { setFieldValue, values } = useFormikContext<CreateOrder>();
                ...
                <ITableBody>
                  {values.items.map((item, index) => (
                    <Tr key={index}>
                          ...
                          defaultValue={
                            (initialData &&
                              ...
                              ? {
                                ...
                                price: initialData.items[index].price
                              }
                              : undefined
                          }
                      ...
                      <Td>{item.vat ? viewStandardVATRate({ rate: item.vat }) : "-"}</Td>
                      <Td>
