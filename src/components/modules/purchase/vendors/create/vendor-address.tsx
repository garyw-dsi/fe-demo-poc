...
import ModulePurchaseVendorFormLayout from "../layout";
      ...
      <Stack spacing={4}>
        ...
        {values.address?.[index]?.address_type && (
          <Fragment>
            ...
            >
              <ModuleInputLabel label="Vendor Address" />
              <Field
                as={ModuleInput}
            ...
            >
              <ModuleInputLabel label="Vendor Phone" />
              <InputGroup>
            ...
            >
              <ModuleInputLabel label="Vendor Email" />
              <Field
                as={ModuleInput}
...
export default function ModulePurchaseVendorAddressForm() {
  const addAddressRef = useRef<HTMLButtonElement>(null);
  const { values } = useFormikContext<CreateVendor>();
