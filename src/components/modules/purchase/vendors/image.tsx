...
import { CreateCustomer } from "@/libs/yup/crm/customers";

interface ModulePurchaseVendorSetImageProps {
...
export default function ModulePurchaseVendorSetImage({
  setFile
}: ModulePurchaseVendorSetImageProps) {
  const toast = useToast();
  const imageRef = useRef<HTMLInputElement>(null);
  const { setFieldValue, values, setTouched } = useFormikContext<CreateCustomer>();
